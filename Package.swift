...
let package = Package(
    ...
    targets: [
      .target(name: "CouchDB-Kitura", dependencies: [ .target(name: "Application"), "Kitura" , "HeliumLogger"]),
      
      .target(name: "Application", dependencies: [ "Kitura", "CloudEnvironment","SwiftMetrics", "Health","CouchDB","FileKit",
